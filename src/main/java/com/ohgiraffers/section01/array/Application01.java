...
public class Application01 {
    ...
    public static void main(String[] args) {
        ...
        *  */
        ...
        /* 필기. 하나의 이름으로 관리되는 연속된 메모리공간이고, 공간마다 찾아갈 수 있는 번호 (인덱스)를 이용해 접근한다. */
        arr[0] = 10;
        arr[1] = 20;
        arr[2] = 30;
        arr[3] = 40;
        ...
        *   new 연산자는 heap 영역에 공간을 할당하고 발생한 주소값을 반환하는
...
//        age[4] = 50;
        ...
        *  */
        ...
        /* 필기.
        *   자바에서 지정한 기본값 외의 값으로 초기화 하고 깊으면 블럭({}) 을 이용한다.
        *   블럭({}) 을 사용하는 경우 new 를 사용하지 않아도 되며, 값의
        *   갯수 만큼 자동으로 크기가 설정된다.
        *  */
        ...
        //문자열 배열을 만들어 보자.
        String[] sarr = {"apple", "banane", "grape", "orange"};
